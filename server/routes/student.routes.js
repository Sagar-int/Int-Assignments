...
import { passTokenConfig } from "../configuration/passportConfig.js";
passTokenConfig(passport);


var router = express.Router();

//Get all Subjects
router.route("/all").get(passport.authenticate("jwt", { session: false }),Get_Subjects);
