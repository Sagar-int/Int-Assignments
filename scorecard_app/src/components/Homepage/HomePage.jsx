	...
	return (
		<Container fluid="md" className="main_container">
			...
			<Row xs="auto" className="part_common_row">
				...
				<Col xs="auto" md={4} className="part_column part_2">
					<div className="sub_heading_div">
						<span className="sub_heading">PART-II : CO-SCOLASTIC AREAS</span>

						{/* Button to Add the Skill details */}
						<Button variant="primary" size="sm" className="edit_logo" onClick={() => handleShow('skill')}>
							<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
								<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
								<path
									fill-rule="evenodd"
			...
			<Row>
				<div className="sub_heading_div">
					...
					<Button variant="primary" size="sm" className="edit_logo" onClick={() => handleShow('attendence')}>
						<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
							<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
							<path
								fill-rule="evenodd"
